...
## Now for a bit of clipping

Now to fine tune this plot, we will turn off clipping of graphics outside of the main plotting rectangle.

i borrowed this idea from a Bob Rudis blog post [here](https://rud.is/b/2015/08/27/coloring-and-drawing-outside-the-lines-in-ggplot/)
...
## Just Show Me the Code in One Chunk
